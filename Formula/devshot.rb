class Devshot < Formula
  ...
  url "https://github.com/devshotcom/homebrew-tap/releases/download/v0.3.30/devshot-macos-arm64-qemu.tar.gz"
  sha256 "95f6edad241a45f3a3cd906b07232823eb1091a55be727316d94d3e18260a1e1"
  license "MIT"
  version "0.3.30"
